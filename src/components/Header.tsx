...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-50 w-full border-b border-stone-200/60 dark:border-stone-800/60 bg-stone-50/80 dark:bg-stone-950/80 backdrop-blur-md"
    >
      <nav
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="block py-2 text-sm font-medium text-stone-600 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-400"
                  >
                    {link.label}
                  </a>
                </li>
